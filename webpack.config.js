/*
This Webpack-config builds a version of ConverterCausalFormats that can be
...
module.exports = (env = {}) => ({
    ...
    entry: src + '/ConvertCausalFormats.js',
    ...
    output: {
        path: dist,
        filename: 'converter-causal-formats.min.js',
        library: 'ConvertCausalFormats',
        libraryTarget: 'var'
    }
});
